...
use crate::{parse_or_none_if_empty, CrateLocalMutableId, Error, PathSegment, Span};

#[derive(Debug, Clone, Default, PartialEq, Eq)]
pub struct MuttestReport {
    // TODO: new type, something like `CrateId`?
    pub muttest_crates: BTreeMap<(String, String), MuttestReportForCrate>,
